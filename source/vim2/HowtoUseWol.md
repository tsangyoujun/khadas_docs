...
Wake-On-LAN (WOL) is a protocol standard that allows your PC/Smartphone to turn on a computer via a local network or the internet.

VIM2 is different with VIM1, as it supports the WOL-function.
